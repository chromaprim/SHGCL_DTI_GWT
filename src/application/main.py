...
sys.path.append('../')
from src.data_process.GetMp import get_mp
from src.data_process.GetPos import get_pos
from src.model.SHGCL import SHGCL
from src.tools.args import parse_args
from src.tools.tools import load_data, ConstructGraph, load_feature, compute_auc_aupr
import warnings
